...
class Search extends React.Component {
  ...
  // Implement the debounceSearch() method
  /**
  ...
  //Implement a lifecycle method which uses getProducts() to fetch data and update state if user's logged in, after the component is loaded
  /**
  ...
  // : Implement getProductElement(). If not logged in, clicking on "Add to Cart" should redirect user to the login page
  /**
    ...
    return (
      <>
        ...
        <Header history={this.props.history}>
          {/*Display search bar in the header for Products page */}
        ...
        <Row>
          ...
          {this.state.loggedIn && this.products.length && (
            <Col md={{ span: 6 }} xs={{ span: 24 }} className="search-cart">
              <div>
                {/*Add a Cart to the products page */}
                <Cart
